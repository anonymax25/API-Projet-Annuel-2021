...
const private_files_controller_1 = require("./private-files.controller");
let PrivateFilesModule = class PrivateFilesModule {
};
PrivateFilesModule = __decorate([
    common_1.Module({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([private_file_entity_1.default], 'POSTGRES'),
            config_1.ConfigModule,
        ],
        controllers: [
            private_files_controller_1.PrivateFilesController
        ],
...
//# sourceMappingURL=private-files.module.js.map